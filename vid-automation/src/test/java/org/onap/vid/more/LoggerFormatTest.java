...
public class LoggerFormatTest extends BaseApiTest {
    ...
    public static Object[][] logsAndFormats(Method test) {
        return new Object[][]{
                {LogName.debug, "debug"},
                {LogName.metrics2019, "metric-ELS-2019.11"}
        };
    }


    @Test(dataProvider = "logsAndFormats")
    public void validateLogsAndFormat(LogName logName, String logCheckerFormat){
        validateLogsFormat(logName, logCheckerFormat);
    }
     ...
     */
    public static List<String> getLogLinesAsList (LogName logname,int maxRows, int minRows, RestTemplate
    restTemplate, URI uri){
     ...
     */
    public static List<String> getRequestLogLines (String requestId, LogName logname, RestTemplate restTemplate, URI
    uri){
    ...
    public static void verifyExistenceOfIncomingReqsInAuditLogs (RestTemplate restTemplate, URI uri, String
    requestId,
            String path){
    ...
    public static void assertHeadersAndMetricLogs (RestTemplate restTemplate, URI uri, String requestId, String path,
    int requestsSize){
