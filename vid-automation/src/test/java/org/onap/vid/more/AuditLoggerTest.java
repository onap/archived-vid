...
public class AuditLoggerTest extends BaseApiTest {
    ...
    public void aaiController2$GetVpnList_requestIdIsAuditedInEntryAndInExit() {
        ...
        assertThat("request id must be found in two rows", getRequestLogLines(requestId),
            contains(
    ...
    protected List<String> getRequestLogLines(String requestId) {
        String logLines = LoggerFormatTest.getLogLines(LOG_NAME.audit2019, 15, 2, restTemplate, uri);
