...
public class NewServiceInstanceTest extends CreateInstanceDialogBaseTest {
    ...
    public void createNewServiceInstance_aLaCarte_WithVnf() {
        ...
        String vfm0RequestId = UUID.randomUUID().toString();
        String vfm0InstanceId = UUID.randomUUID().toString();
        String vg1RequestId = UUID.randomUUID().toString();
        String vg1InstanceId = UUID.randomUUID().toString();
        String vfm1RequestId = UUID.randomUUID().toString();
        String vfm1InstanceId = UUID.randomUUID().toString();
        String vfm12RequestId = UUID.randomUUID().toString();
        String vfm12InstanceId = UUID.randomUUID().toString();
    ...
    static class ServiceData {
        ...
        ServiceData(String modelUuid, List<String> dynamicFields, IS_GENERATED_NAMING isServiceGeneratedNaming,
            ...
            this.vfData = new VfData(vfName, isVgEnabled, vfMin, vfMax, vfModuleDynamicFields, vfVersionId, null);
        }
