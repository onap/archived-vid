...
public class TemplateInstantiationTest extends ModernUITestBase {
    ...
    public void instantiateALaCarteServiceFromTemplateTest() {
        ...
        selectTemplateByNameAndClickTemplate(templateInstanceName);
    ...
    private void selectTemplateByNameAndClickTemplate(String templateInstanceName) {
    ...
    private void switchBetweenIframes() {
        viewEditPage.goOutFromIframe();
        viewEditPage.goToIframe();
    }
