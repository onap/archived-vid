...
public class PrestAAIPutVnfsFromServiceInstanceFilter extends PresetBaseAAICustomQuery {

    private final String globalCustomerId;
    private final String serviceType;
    private final String nfRole;
    private final String vnfName;

    public PrestAAIPutVnfsFromServiceInstanceFilter(String globalCustomerId, String serviceType, String nfRole, String vnfName) {
        super(SIMPLE,
    ...
    public Object getResponseBody() {
        return "{"
            ...
            + "              \"related-to\": \"service-instance\","
            + "              \"relationship-label\": \"org.onap.relationships.inventory.ComposedOf\","
            + "              \"related-link\": \"/aai/v17/business/customers/customer/a9a77d5a-123e-4ca2-9eb9-0b015d2ee0fb/service-subscriptions/service-subscription/vRichardson/service-instances/service-instance/97315a05-e6f3-4c47-ae7e-d850c327aa08\","
            + "              \"relationship-data\": ["
            + "                {"
            + "                  \"relationship-key\": \"customer.global-customer-id\","
            + "                  \"relationship-value\": \""+globalCustomerId+"\""
            + "                },"
            + "                {"
            + "                  \"relationship-key\": \"service-subscription.service-type\","
            + "                  \"relationship-value\": \""+serviceType+"\""
            + "                },"
            + "                {"
            + "                  \"relationship-key\": \"service-instance.service-instance-id\","
            + "                  \"relationship-value\": \"97315a05-e6f3-4c47-ae7e-d850c327aa08\""
            + "                }"
            + "              ],"
            + "              \"related-to-property\": ["
            + "                {"
