...
.. code-block:: bash
  ...
  docker pull nexus3.onap.org:10001/onap/vid:4.2.0
...
.. code-block:: bash
   ...
   #start VID server
   docker run -e VID_MYSQL_DBNAME=vid_openecomp_epsdk -e VID_MYSQL_PASS=YOUR_PASSWORD --name vid-server -p 8080:8080 --link vid-mariadb:vid-mariadb-docker-instance -d nexus3.onap.org:10001/onap/vid:4.2.0
