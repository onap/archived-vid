...
(function () {
    ...
    appDS2.controller("reportModalController", ["$uibModalInstance", "$scope", "ReportService", "errorMsg", reportModalController]);

    function reportModalController($uibModalInstance, $scope, ReportService, errorMsg) {
        const vm = this;
