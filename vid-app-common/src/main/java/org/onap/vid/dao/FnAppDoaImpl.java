...
public class FnAppDoaImpl {
    ...
    @Autowired
    public FnAppDoaImpl(FnAppDbConnection fnAppDbConnection) {
        this.fnAppDbConnection = fnAppDbConnection;
    }
    ...
    public int getProfileCount(String URL, String username, String password) throws SQLException {
        ...
        int count = 0;
        try (Connection dbc = fnAppDbConnection.getConnection(URL, username, password)) {
