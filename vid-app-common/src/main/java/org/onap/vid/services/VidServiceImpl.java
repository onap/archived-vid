...
public class VidServiceImpl implements VidService {
    ...
    public ExternalComponentStatus probeSDCConnection() {
        ...
        try {
            ...
            HttpRequestMetadata httpRequestMetadata = new HttpRequestMetadata(stringHttpResponse, HttpMethod.GET, "VID-SDC connection works",
            ...
            HttpRequestMetadata httpRequestMetadata = new HttpRequestMetadata(HttpMethod.GET, HttpStatus.INTERNAL_SERVER_ERROR.value()
                    , AsdcClient.URIS.HEALTH_CHECK_ENDPOINT, "", e.getMessage(), System.currentTimeMillis() - startTime);
