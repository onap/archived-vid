...
public class ErrorReportController extends UnRestrictedBaseController {
	...
	@PostMapping(value = "error-report", produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
	public Map<String, Object> getErrorReport(HttpServletRequest request,
		...
		HashMap<String, Object> report = new HashMap<>(generateReportsData(request, creationParameters));
		report.put("creationParameters", creationParameters);
		return report;
	}
