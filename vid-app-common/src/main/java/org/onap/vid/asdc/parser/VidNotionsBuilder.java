...
public class VidNotionsBuilder {
    ...
    public VidNotionsBuilder(FeatureManager featureManager) {
        ...
        try {
            InputStream uuidInputStream = VidNotionsBuilder.class.getResourceAsStream(
                "/macro_services_by_invariant_uuid.json");
            invariantToMacro = uuidInputStream == null ?
                Collections.emptySet() :
                new HashSet<>(JACKSON_OBJECT_MAPPER.readValue(uuidInputStream, new TypeReference<List<String>>() {}));
