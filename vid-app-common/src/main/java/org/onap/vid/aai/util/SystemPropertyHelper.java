...
public class SystemPropertyHelper {
    ...
    public static Optional<String> getAAIUseClientCert(){
        return getSystemProperty(AAIProperties.AAI_USE_CLIENT_CERT);
    }

    public static Optional<String> getAAIServerUrl(){
        return getSystemProperty(AAIProperties.AAI_SERVER_URL);
    }

    public static Optional<String> getAAIVIDUsername(){
        return getSystemProperty(AAIProperties.AAI_VID_USERNAME);
    }

    public static Optional<String> getAAIVIDPasswd(){
        return getSystemProperty(AAIProperties.AAI_VID_PASSWD_X);
    }

    public static boolean isClientCertEnabled() {
        return getAAIUseClientCert().isPresent() &&
                getAAIUseClientCert().orElseGet(() -> "false").equalsIgnoreCase("true");
    }

    public static String getFullServicePath(String path) {
        return getAAIServerUrl().orElse("") + path;
    }

    public static String getEncodedCredentials() throws InvalidPropertyException, UnsupportedEncodingException {
    ...
    private static Optional<String> getSystemProperty(String propertyKey){
