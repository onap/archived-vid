...
public final class OperationalEnvironment {
    ...
    @JsonCreator
    OperationalEnvironment(@JsonProperty("operational-environment-id") String operationalEnvironmentId,
        @JsonProperty("operational-environment-name") String operationalEnvironmentName,
        @JsonProperty("operational-environment-type") String operationalEnvironmentType,
        @JsonProperty("operational-environment-status") String operationalEnvironmentStatus,
        @JsonProperty("tenant-context") String tenantContext,
        @JsonProperty("workload-context") String workloadContext,
