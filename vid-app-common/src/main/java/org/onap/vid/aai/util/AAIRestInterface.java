...
public class AAIRestInterface {
	...
	private final BaseUrlProvider serverUrlProvider;
	private final BaseUrlProvider serverBaseUrlProvider;
	...
	public AAIRestInterface(HttpsAuthClient httpsAuthClientFactory, ServletRequestHelper servletRequestHelper, SystemPropertyHelper systemPropertyHelper, BaseUrlProvider serverUrlProvider, BaseUrlProvider serverBaseUrlProvider) {
	...
	public ResponseWithRequestInfo RestGet(String fromAppId, String transId, String requestUri, boolean xml, boolean propagateExceptions) {
		...
		String url = serverUrlProvider.getBaseUrl();
		try {
	...
	public Response RestPost(String fromAppId, String path, String payload, boolean xml) {
        ...
        String url = serverBaseUrlProvider.getBaseUrl();
		String transId = UUID.randomUUID().toString();
		logger.debug(EELFLoggerDelegate.debugLogger, methodName + START_STRING);
