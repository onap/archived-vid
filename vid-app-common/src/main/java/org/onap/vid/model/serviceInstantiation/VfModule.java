...
public class VfModule extends BaseResource implements JobAdapter.AsyncJobRequest {
	...
	@JsonInclude(NON_NULL)
	private final String pauseInstantiation;
	...
	public VfModule(@JsonProperty("modelInfo") ModelInfo modelInfo,
		...
		@JsonProperty("pauseAfterCompletion") String pauseInstantiation,
	...
	@Nullable
	public String getPauseInstantiation() {return pauseInstantiation;}
