...
public class MsoRestClientNew extends RestMsoImplementation implements MsoInterface {
    ...
    @Override
    public MsoResponseWrapper invokeWorkflow(WorkflowRequestDetail workflowRequestDetail,String invokeWorkflowsPath) {
        ...
        HttpResponse<JsonNode> response = client.post(path, commonHeaders, requestDetailsWrapper);
        return MsoUtil.wrapResponse(response);
    }
