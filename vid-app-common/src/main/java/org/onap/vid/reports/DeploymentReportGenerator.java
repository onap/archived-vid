...
public class DeploymentReportGenerator implements ReportGenerator {
	...
	Map<String, Object> getServiceDetails(String serviceUuid) {
		try {
			...
			return ImmutableMap.of("details", serviceModel);
		} catch (AsdcCatalogException | NullPointerException e) {
			return generateServiceDetailsExceptionResponse(serviceUuid, e);
		}
	}

	private Map<String, Object> generateServiceDetailsExceptionResponse(String serviceUuid, Exception e) {
		Map<String, Object> result = new HashMap<>();
		if (e.getClass() == NullPointerException.class) {
			result.put("message", "Service with given uuid was not found");
		}
