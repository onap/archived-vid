...
public class SampleApiTest extends BaseApiTest {
    ...
    private void callWithFineRequest(String expectationJsonFileName, ImmutableMap<String, Object> replacementsForJson, String targetUri, String requestBody, int expectedStatusCode, String expectedResult) throws IOException {
