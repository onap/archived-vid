...
public class HealthCheckControllerTest {
    ...
    private void setProfileCountNumber(int nr) throws SQLException {
        given(fnAppDoa.getProfileCount(anyString(), anyString(), anyString()))
                .willReturn(nr);
    }

    private void setProfileCountThrows() throws SQLException {
        given(fnAppDoa.getProfileCount(anyString(), anyString(), anyString()))
