...
public class VidWorkflowsControllerTest {
    ...
    private static final String VID_WORKFLOWS = "/vid/instanceManagement/v1/serviceInstances/{serviceInstanceId}/vnfs/{vnfInstanceId}/workflows/{workflow_UUID}";
    ...
    public void shouldProperlyReceivePostRequestFromUI() throws Exception {
        ...
        given(msoRestClientNew.invokeWorkflow(uiWorkflowsRequest.getRequestDetails(),"/onap/so/infra/instanceManagement/v1/serviceInstances/10/vnfs/20/workflows/30")).willReturn(MsoUtil.wrapResponse(expectedResponse));

        //  when
        ResultActions response = mockMvc.perform( post(VID_WORKFLOWS, "test1","test2","test3")
