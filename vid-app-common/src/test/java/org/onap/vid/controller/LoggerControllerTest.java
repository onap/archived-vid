...
public class LoggerControllerTest {
    ...
    private final String ERROR_URL = "/logger/error";
    private final String AUDIT_URL = "/logger/audit";
    private final String METRICS_URL = "/logger/metrics";

    private final String VALID_LOG_PATH = "src/test/java/org/onap/vid/controller/testResources/validLog.log";
    private final String EMPTY_LOG_PATH = "src/test/java/org/onap/vid/controller/testResources/emptyLog.log";
