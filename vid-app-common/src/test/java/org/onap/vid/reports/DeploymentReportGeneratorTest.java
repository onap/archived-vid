...
public class DeploymentReportGeneratorTest {
	...
	@Test
	public void shouldGetNullPointerExceptionInfoInMapWhenWrongUuidIsGiven() throws AsdcCatalogException {
		//given
		...
		when(vidService.getService(NOT_EXISTING_UUID)).thenThrow(expectedException);

		//when
		Map<String, Object> actualResult = deploymentReportGenerator.getServiceDetails(NOT_EXISTING_UUID);
