...
//        HttpResponse<Pnf> specificPnf = aaiService.getSpecificPnf("1345667");
//        assertNotNull(specificPnf);
//        pnf = specificPnf.getBody();
//        assertNotNull(pnf);
//        assertEquals("11111", pnf.getPnfId());
//        assertEquals("aaaa", specificPnf.getStatusText());
//        assertEquals(200, specificPnf.getStatus());
//    }
//
//    @Test
...
//        HttpResponse<AaiGetPnfResponse> aaiGetPnfResponseWrapper = aaiService
//            .getPNFData("1345667", "1345667", "1345667", "1345667", "1345667", "1345667", "1345667");
//        assertNotNull(aaiGetPnfResponseWrapper);
//        aaiGetPnfResponse = aaiGetPnfResponseWrapper.getBody();
...
//        HttpResponse<GetTenantsResponse[]> actualTenants = aaiService
//            .getTenants(serviceGlobalCustomerId, serviceServiceType, roleValidator);
//
//        assertThat(actualTenants.getBody(), arrayWithSize(1));
//        assertThat(actualTenants.getBody()[0].tenantName, equalTo(serviceTenantName));
