...
public class InstantiationModelSerializationTest {
    ...
    @Test
    public void serializeAndDeserializeVfModule()
    ...
    @Test
    public void serializeAndDeserializeVnf()
        throws JsonProcessingException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
    ...
    @Test
    public void serializeAndDeserializeServiceInstantiation()
        throws JsonProcessingException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        ServiceInstantiation serviceInstantiation = new ServiceInstantiation(
            ...
            true,
            "statusMessage",
            new VidNotions(InstantiationUI.ANY_ALACARTE_WHICH_NOT_EXCLUDED, ModelCategory.INFRASTRUCTURE_VPN, InstantiationUI.INFRASTRUCTURE_VPN, InstantiationType.Macro)
            );
    ...
    private void verifySerializationAndDeserialization(Object object)
