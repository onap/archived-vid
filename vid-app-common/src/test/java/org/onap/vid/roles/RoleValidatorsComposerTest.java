...
public class RoleValidatorsComposerTest {
    ...
    public static Object[][] allInterfaceFunctions() {
        return Stream.<Function<RoleValidator, Boolean>>of(
            ...
            (RoleValidator o) -> o.isServicePermitted("subscriberId", "serviceType"),
    ...
    @Test(dataProvider = "allInterfaceFunctions")
    public void falseThenTrueComposite_returnsTrue(Function<RoleValidator, Boolean> interfaceFunction) {
        ...
        interfaceFunction.apply(verify(alwaysFalseRoles, times(2)));
        interfaceFunction.apply(verify(alwaysTrueRoles, times(1)));
    }

    @Test(dataProvider = "allInterfaceFunctions")
    public void trueThenFalseComposite_returnsTrueAndShortCircuits(Function<RoleValidator, Boolean> interfaceFunction) {
    ...
    @Test(dataProvider = "allInterfaceFunctions")
    public void falseThenFalseComposite_returnsFalse(Function<RoleValidator, Boolean> interfaceFunction) {
