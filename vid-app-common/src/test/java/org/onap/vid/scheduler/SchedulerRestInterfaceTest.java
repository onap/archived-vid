...
public class SchedulerRestInterfaceTest {
    ...
    private static Map<String, String> DUMMY_SYSTEM_PROPERTIES = ImmutableMap.of(
            SchedulerProperties.SCHEDULER_USER_NAME_VAL, SAMPLE_USERNAME,
            SchedulerProperties.SCHEDULER_PASSWORD_VAL, SAMPLE_PASSWORD,
            SchedulerProperties.SCHEDULER_SERVER_URL_VAL, SAMPLE_SCHEDULER_SERVER_URL);
    @Mock
