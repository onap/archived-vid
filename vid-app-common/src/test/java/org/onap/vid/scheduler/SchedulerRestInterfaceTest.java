...
public class SchedulerRestInterfaceTest {
    ...
    public void tearDown() {
        Mockito.reset(mockedHttpsAuthClient);
        Mockito.reset(mockedClient);
        Mockito.reset(mockedBuilder);
        Mockito.reset(mockedResponse);
        Mockito.reset(mockedWebTarget);
        Mockito.reset(propertyGetter);
    }
    ...
    @Test
    public void testShouldGetOKWhenStringIsExpected() throws IOException, ParseException, GeneralSecurityException {
    ...
    @Test
    public void testShouldDeleteSuccessfully() throws IOException, ParseException, GeneralSecurityException {
