...
--
INSERT IGNORE INTO `fn_app` VALUES (1,'Default','assets/images/tmp/portal1.png','Some Default Description','Some Default Note','http://www.att.com','http://www.att.com',NULL,'ECPP','?',1,'okYTaDrhzibcbGVq5mjkVQ==','N','N',NULL,'Default',NULL,NULL,'ECOMP-PORTAL-INBOX');

--
-- Dumping data for table `fn_datasource`
--
REPLACE INTO `fn_datasource` VALUES (1,'Hive2-bragi08','org.apache.hive.jdbc.HiveDriver',NULL,NULL,NULL,NULL,'jdbc:hive2://bragi09.homer.att.com:10000/default;user=hdfs',1,5,1,'BIGDATA');
REPLACE INTO `fn_datasource` VALUES (2,'BigData - Q Oracle','oracle.jdbc.driver.OracleDriver',NULL,NULL,'quantumbd','c1syn2yhmr','jdbc:oracle:thin:@titan.homer.att.com:1621:tid111d',1,5,NULL,'RDBMS');
REPLACE INTO `fn_datasource` VALUES (3,'Hive2-Galeru04','org.apache.hive.jdbc.HiveDriver',NULL,NULL,NULL,NULL,'jdbc:hive2://galeru03.homer.att.com:10000/default;user=hdfs',1,5,1,'BIGDATA');
