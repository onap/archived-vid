...
export enum UpgradeFormControlNames {
  RETAIN_VOLUME_GROUP = 'retainVolumeGroup',
...
export class VfModuleUpgradePopupService extends VfModulePopuopService {
  ...
  onSubmit(that, form: FormGroup) {
    ...
    this.updateVFModuleField(UpgradeFormControlNames.RETAIN_VOLUME_GROUP,node, serviceInstanceId, form);
  ...
  getRetainVolumeGroupsControl = (): CheckboxFormControl => {
    return new CheckboxFormControl({
      ...
      controlName: UpgradeFormControlNames.RETAIN_VOLUME_GROUP,
      displayName: 'Retain Volume Groups',
      dataTestId: UpgradeFormControlNames.RETAIN_VOLUME_GROUP,
      value: true,
      validations: []
    })
  };
