...
describe('Generic Form popup Service', () => {
  ...
  test('get table headers should return all headers in the right order', () => {
    const headers: string[] = service.getTableHeaders();
    expect(headers).toEqual(['User ID', 'Date', 'Instance Name', 'Instantiation Status', 'Summary', 'Region', 'Tenant', 'AIC Zone']);
  });
