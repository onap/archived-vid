...
import {FormControlNames} from "./vfModuleGenerator/vfModule.control.generator";
...
export class BasicControlGenerator {
  ...
  getSupplementaryFile(instance: any): FileFormControl {
    return new FileFormControl({
      ...
      onDelete : this.getOnDeleteForSupFile(),
      onChange : this.getOnChangeForSupFile()
    })
  };

  private getOnDeleteForSupFile() {
