...
describe('VFModule Control Generator', () => {
  ...
  each([
    [true, 4, [FormControlNames.INSTANCE_NAME, FormControlNames.VOLUME_GROUP_NAME, FormControlNames.ROLLBACK_ON_FAILURE,SDN_C_PRE_LOAD,],
    ],
    [false, 7,[FormControlNames.INSTANCE_NAME, FormControlNames.VOLUME_GROUP_NAME, FormControlNames.LCPCLOUD_REGION_ID, FormControlNames.LEGACY_REGION, FormControlNames.TENANT_ID, FormControlNames.ROLLBACK_ON_FAILURE,SDN_C_PRE_LOAD,],
    ],
  ]).
  ...
  each([
    [true, [SDN_C_PRE_LOAD, FormControlNames.INSTANCE_NAME, FormControlNames.VOLUME_GROUP_NAME, FormControlNames.ROLLBACK_ON_FAILURE,],
    ],
    [false, [SDN_C_PRE_LOAD, FormControlNames.INSTANCE_NAME, FormControlNames.VOLUME_GROUP_NAME, FormControlNames.LCPCLOUD_REGION_ID, FormControlNames.TENANT_ID, FormControlNames.LEGACY_REGION,FormControlNames.ROLLBACK_ON_FAILURE]
    ],
  ]).
