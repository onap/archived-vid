...
describe('VFModule Control Generator', () => {
  ...
  const cases = [[true, true, null],[false, true, "vf_vgeraldine0..VfVgeraldine..base_vflorence..module-0_vol"],[false, false, null]];

  test.each(cases)('Given Ecomp Gen Name: %p and VG Name %p - expect the name value for VG to be %p',
    (ecomGenName, vGName, expectedValue) => {
