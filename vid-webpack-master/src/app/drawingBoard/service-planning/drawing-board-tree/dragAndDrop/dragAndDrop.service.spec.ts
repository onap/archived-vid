...
describe('Drag and drop service', () => {
  ...
  test.only('drop should change nodes index and position', () => {
  ...
  test('drag shouldnt execute array_move when the to index is 0(any other node trying to take first position)', () => {
  ...
  test('drag shouldnt execute array_move when the from node is base module', () => {
