...
describe('Shared Tree Service', () => {
  ...
  each([
    ['model from hierarchy', null, getNetworkModelInfoFromHierarchy(), '2.0'],
    ['undefined model', null, null, undefined],
    ['model from hierarchy', getSelectedModelInfo(), null, '5.0'],
    ['model from hierarchy', getSelectedModelInfo(), getNetworkModelInfoFromHierarchy(), '5.0'],
  ]).
  ...
  each([
    ['model from hierarchy', null, getNetworkModelInfoFromHierarchy(), 'customization-id-from-hierarchy'],
    ['undefined model', null, null, undefined],
    ['model from instance', getSelectedModelInfo(), null, 'model-customization-id-from-instance'],
    ['model from instance', getSelectedModelInfo(), getNetworkModelInfoFromHierarchy(), 'model-customization-id-from-instance'],
  ]).
