...
describe('Shared Tree Service', () => {
  ...
  each([
    [vfModuleNodeNotExistsOnHierarchy, 'fa59d7f3-be3d-4081-95e8-f46624b1ed56', true],
    [vfModuleNodeExistsOnHierarchy, 'fa59d7f3-be3d-4081-95e8-f46624b1ed56', false]
  ]).
  test('given vfModule customization id %s and serviceModelId %s then isVfModuleCustomizationIdNotExistsOnModel check if vfmodule exits in hierarchy', (
