...
describe('View Edit Page: Upgrade VFModule', function () {
  ...
  describe('More UI test', () => {
    ...
    it.only(`Upgrade a VFModule: upgrade vfmodule when upgraded already service, vnf and borther vfmodule e2e`, function () {
      ...
      upgradeTheVFM('node-3412fe1f-e103-4777-90c0-f66d888f4bed-3412fe1f-e103-4777-90c0-f66d888f4bed', false);
