...
describe('View Edit Page: Upgrade VFModule', function () {
  describe('basic UI tests', () => {
    ...
    it(`Upgrade a VF Module`, function () {
      ...
      upgradeTheVFM('node-522159d5-d6e0-4c2a-aa44-5a542a12a830-vf_vgeraldine0..VfVgeraldine..vflorence_vlc..module-1');
  ...
  function upgradeTheVFM(treeNodeId: string, shouldCheckVGCheckboxVisibility :boolean = true) {
    ...
    if (shouldCheckVGCheckboxVisibility) {
