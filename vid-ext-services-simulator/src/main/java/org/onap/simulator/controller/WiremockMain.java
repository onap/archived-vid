...
public class WiremockMain {
    ...
    private final ImmutableWireMockServer wiremockServer;

    @Autowired
    WiremockMain(ImmutableWireMockServer wiremockServer) {
    ...
    void init() {
        ...
        logger.info("VID Simulator started successfully on port {}", wiremockServer.getPort());
