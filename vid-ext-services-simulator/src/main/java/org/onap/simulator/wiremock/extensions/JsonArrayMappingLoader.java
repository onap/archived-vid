...
public class JsonArrayMappingLoader extends JsonFileMappingsSource {
    ...
    public JsonArrayMappingLoader(FileSource filesRoot, boolean enabled) {
        super(getMappingSource(filesRoot));
        this.mappingsSource = getMappingSource(filesRoot);
    ...
    public void loadMappingsInto(StubMappings stubMappings) {
        ...
        if (enabled) {
            mappingsSource
                ...
                .stream()
                .filter(byFileExtension("json")::apply)
    ...
    private static FileSource getMappingSource(FileSource filesRoot) {
        return filesRoot.child(MAPPINGS_ROOT);
    }
